...
You can start up an in-memory test engine and do assertions by adding this annotation to you test class:
...
Note that **the test engines requires Java version >= 21**. If you cannot run on this Java version, you can use [Testcontainers](https://www.testcontainers.org/) **instead**. Testcontainers require that you have a Docker installation locally available on the developer machine. Use this annotation:
...
An example test case is [available here](https://github.com/camunda/zeebe/blob/main/spring-boot-starter-camunda-sdk/src/test/java/io/camunda/zeebe/spring/client/jobhandler/JobHandlerEmbeddedTest.java).
